...
Game.create(:game, player_id: @player.id, level: "Beginner", min_bet: 1, max_bet: 50, deck_sleeve: "Heart,Ace|")
Game.create(:game, player_id: @player.id, level: "Intermediate", min_bet: 50, max_bet: 100,deck_sleeve: "Heart,Ace|")
Game.create(:game, player_id: @player.id, level: "High Roller", min_bet: 100, max_bet: nil,deck_sleeve: "Heart,Ace|")
